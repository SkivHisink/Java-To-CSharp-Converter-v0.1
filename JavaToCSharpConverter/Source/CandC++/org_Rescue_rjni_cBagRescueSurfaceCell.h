...
#include <jni.h>
/* Header for class org_Rescue_rjni_cBagRescueSurfaceCell */

#ifndef _Included_org_Rescue_rjni_cBagRescueSurfaceCell
#define _Included_org_Rescue_rjni_cBagRescueSurfaceCell
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     org_Rescue_rjni_cBagRescueSurfaceCell
 * Method:    Create_cBagRescueSurfaceCell0
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_org_Rescue_rjni_cBagRescueSurfaceCell_Create_1cBagRescueSurfaceCell0
  (JNIEnv *, jobject);

/*
 * Class:     org_Rescue_rjni_cBagRescueSurfaceCell
 * Method:    Delete_cBagRescueSurfaceCell
 * Signature: (J)V
 */
