...
#include <jni.h>
/* Header for class org_Rescue_rjni_cBagRescueTriangleVertex */

#ifndef _Included_org_Rescue_rjni_cBagRescueTriangleVertex
#define _Included_org_Rescue_rjni_cBagRescueTriangleVertex
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     org_Rescue_rjni_cBagRescueTriangleVertex
 * Method:    Create_cBagRescueTriangleVertex0
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_org_Rescue_rjni_cBagRescueTriangleVertex_Create_1cBagRescueTriangleVertex0
  (JNIEnv *, jobject);

/*
 * Class:     org_Rescue_rjni_cBagRescueTriangleVertex
 * Method:    Delete_cBagRescueTriangleVertex
 * Signature: (J)V
 */
