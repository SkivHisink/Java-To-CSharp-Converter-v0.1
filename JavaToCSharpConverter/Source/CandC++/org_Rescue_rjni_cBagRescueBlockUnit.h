...
#include <jni.h>
/* Header for class org_Rescue_rjni_cBagRescueBlockUnit */

#ifndef _Included_org_Rescue_rjni_cBagRescueBlockUnit
#define _Included_org_Rescue_rjni_cBagRescueBlockUnit
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     org_Rescue_rjni_cBagRescueBlockUnit
 * Method:    Create_cBagRescueBlockUnit0
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_org_Rescue_rjni_cBagRescueBlockUnit_Create_1cBagRescueBlockUnit0
  (JNIEnv *, jobject);

/*
 * Class:     org_Rescue_rjni_cBagRescueBlockUnit
 * Method:    Delete_cBagRescueBlockUnit
 * Signature: (J)V
 */
