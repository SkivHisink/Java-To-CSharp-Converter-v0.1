...
/*****************************************************************
    ...
    cSetRescueGridAxis.java

    Rod Hanks   Sep  5 2005

******************************************************************/
public class cSetRescueGridAxis extends RjniBaseClass
{


  protected cSetRescueGridAxis(long ndxIn)
  {
    nativeNdx = ndxIn;
  }

  public cSetRescueGridAxis()
  {
    nativeNdx = Create_cSetRescueGridAxis0();
  }

  public void dispose()
  {
    Delete_cSetRescueGridAxis(nativeNdx);
  }

  public void AddTo(RescueGridAxis newObject)
  {
    AddTo2(nativeNdx
               ,(newObject == null) ? 0 : newObject.nativeNdx);
  }

  public boolean RemoveFrom(RescueGridAxis existingObject)
  {
  ...
  public RescueGridAxis NthObject(long ordinal)
  {
  ...
  public RescueGridAxis NthObject(int ordinal)
  {
    return NthObject((long) ordinal);
  }

  public RescueGridAxis ObjectNamed(java.lang.String nameIn)
  {
  ...
  public RescueGridAxis ObjectIdentifiedBy(long identifier)
  {
  ...
  public RescueGridAxis ObjectIdentifiedBy(int identifier)
  {
  ...
  private native long Create_cSetRescueGridAxis0();
  private native void Delete_cSetRescueGridAxis(long ndx);
