...
/*****************************************************************
    ...
    cSetRescueLookup.java

    Rod Hanks   Sep  5 2005

******************************************************************/
public class cSetRescueLookup extends RjniBaseClass
{


  protected cSetRescueLookup(long ndxIn)
  {
    nativeNdx = ndxIn;
  }

  public cSetRescueLookup()
  {
    nativeNdx = Create_cSetRescueLookup0();
  }

  public void dispose()
  {
    Delete_cSetRescueLookup(nativeNdx);
  }

  public void AddTo(RescueLookup newObject)
  {
    AddTo2(nativeNdx
               ,(newObject == null) ? 0 : newObject.nativeNdx);
  }

  public boolean RemoveFrom(RescueLookup existingObject)
  {
  ...
  public RescueLookup NthObject(long ordinal)
  {
  ...
  public RescueLookup NthObject(int ordinal)
  {
    return NthObject((long) ordinal);
  }

  public RescueLookup ObjectNamed(java.lang.String nameIn)
  {
  ...
  public RescueLookup ObjectIdentifiedBy(long identifier)
  {
  ...
  public RescueLookup ObjectIdentifiedBy(int identifier)
  {
  ...
  private native long Create_cSetRescueLookup0();
  private native void Delete_cSetRescueLookup(long ndx);
