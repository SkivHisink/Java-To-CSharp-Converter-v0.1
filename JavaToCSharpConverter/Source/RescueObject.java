...
******************************************************************/
public class RescueObject extends RjniBaseClass
{
  ...
  public boolean IsIdentifiedBy(long possibleID)
  {
    boolean myReturn = IsIdentifiedBy0(nativeNdx
                                         ,possibleID);
    return myReturn;
  }
  ...
  {
    boolean myReturn = IsNamed2(nativeNdx
                                  ,mayBeName);
    return myReturn;
  }
  ...
  private native boolean IsIdentifiedBy0(long refNdx
                                        ,long possibleID);
  private native long Identifier1(long refNdx);
  private native boolean IsNamed2(long refNdx
                                 ,java.lang.String mayBeName);
  private native int IsA3(long refNdx);
  private native boolean IsOfType4(long refNdx
                                  ,int thisType);
  private native void Delete_RescueObject(long ndx);
  private native long Create_RescueObject6(long context);
}
