...
/*****************************************************************
    ...
    cSetRescueWellbore.java

    Rod Hanks   Sep  5 2005

******************************************************************/
public class cSetRescueWellbore extends RjniBaseClass
{


  protected cSetRescueWellbore(long ndxIn)
  {
    nativeNdx = ndxIn;
  }

  public cSetRescueWellbore()
  {
    nativeNdx = Create_cSetRescueWellbore0();
  }

  public void dispose()
  {
    Delete_cSetRescueWellbore(nativeNdx);
  }

  public void AddTo(RescueWellbore newObject)
  {
    AddTo2(nativeNdx
               ,(newObject == null) ? 0 : newObject.nativeNdx);
  }

  public boolean RemoveFrom(RescueWellbore existingObject)
  {
  ...
  public RescueWellbore NthObject(long ordinal)
  {
  ...
  public RescueWellbore NthObject(int ordinal)
  {
    return NthObject((long) ordinal);
  }

  public RescueWellbore ObjectNamed(java.lang.String nameIn)
  {
  ...
  public RescueWellbore ObjectIdentifiedBy(long identifier)
  {
  ...
  public RescueWellbore ObjectIdentifiedBy(int identifier)
  {
  ...
  private native long Create_cSetRescueWellbore0();
  private native void Delete_cSetRescueWellbore(long ndx);
