...
/*****************************************************************
    ...
    cSetRescueEdgeSet.java

    Rod Hanks   Sep  5 2005

******************************************************************/
public class cSetRescueEdgeSet extends RjniBaseClass
{


  protected cSetRescueEdgeSet(long ndxIn)
  {
    nativeNdx = ndxIn;
  }

  public cSetRescueEdgeSet()
  {
    nativeNdx = Create_cSetRescueEdgeSet0();
  }

  public void dispose()
  {
    Delete_cSetRescueEdgeSet(nativeNdx);
  }
  ...
  public RescueEdgeSet ObjectNamed(java.lang.String nameIn)
  {
  ...
  public RescueEdgeSet ObjectIdentifiedBy(int identifier)
  {
  ...
  private native long Create_cSetRescueEdgeSet0();
  private native void Delete_cSetRescueEdgeSet(long ndx);
