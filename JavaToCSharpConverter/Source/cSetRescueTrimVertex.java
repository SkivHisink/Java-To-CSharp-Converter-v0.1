...
/*****************************************************************
    ...
    cSetRescueTrimVertex.java

    Rod Hanks   Sep  5 2005

******************************************************************/
public class cSetRescueTrimVertex extends RjniBaseClass
{
  ...
  public boolean RemoveFrom(RescueTrimVertex existingObject)
  {
  ...
  public RescueTrimVertex ObjectNamed(java.lang.String nameIn)
  {
  ...
  private native long Create_cSetRescueTrimVertex0();
  private native void Delete_cSetRescueTrimVertex(long ndx);
  ...
  private native void Relink12(long refNdx
                              ,long parent);
  private native long TrimVertexLocatedBy13(long refNdx
                                            ,float x
                                            ,float y
                                            ,float z);
}
