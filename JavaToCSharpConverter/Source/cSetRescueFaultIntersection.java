...
/*****************************************************************
    ...
    cSetRescueFaultIntersection.java

    Rod Hanks   Sep  5 2005

******************************************************************/
public class cSetRescueFaultIntersection extends RjniBaseClass
{
  ...
  public boolean RemoveFrom(RescueFaultIntersection existingObject)
  {
  ...
  public RescueFaultIntersection ObjectNamed(java.lang.String nameIn)
  {
  ...
  private native long Create_cSetRescueFaultIntersection0();
  private native void Delete_cSetRescueFaultIntersection(long ndx);
  ...
  private native void Relink12(long refNdx
                              ,long parent);
  private native void RelinkWireframeData13(long refNdx
                                           ,long parent);
}
