...
namespace RescueJ
{
public class cSetRescuePolyLineNodeBUG : RjniBaseClass
{
  ...
  public bool RemoveFrom(RescuePolyLineNodeBUG existingObject)
  {
  ...
  public RescuePolyLineNodeBUG ObjectNamed(string nameIn)
  {
