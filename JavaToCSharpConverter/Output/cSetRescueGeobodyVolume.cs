...
namespace RescueJ
{
public class cSetRescueGeobodyVolume : RjniBaseClass
{
  ...
  public bool RemoveFrom(RescueGeobodyVolume existingObject)
  {
  ...
  public RescueGeobodyVolume ObjectNamed(string nameIn)
  {
