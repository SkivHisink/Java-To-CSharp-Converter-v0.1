...
namespace RescueJ
{
public class cSetRescueWellboreProperty : RjniBaseClass
{
  ...
  public bool RemoveFrom(RescueWellboreProperty existingObject)
  {
  ...
  public RescueWellboreProperty ObjectNamed(string nameIn)
  {
